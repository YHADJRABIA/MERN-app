...
const sendEmail = (to, url, txt) => {
  ...
  const mailOptions = {
    ...
    html: `
            ...
            <h2 style="text-align: center; text-transform: uppercase;color: blue;">Welcome to my bogus platform!</h2>
            <p>Congratulations! You're almost set to start using the platform.
                Just click the button below to validate your e-mail address.
            </p>
